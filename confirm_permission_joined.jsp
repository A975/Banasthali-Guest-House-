...
<%
        ...
        if(request.getParameter("btnnotgrant")!=null)
    {
       ...
       //String s=request.getParameter("id");
       out.println(s);
       String qry="delete from PERMISSION_TABLE_HOD_JOINEDFACULTY  where EMAIL_ID='"+s+"' ";
...
out.println(result);}
    ...
    if(request.getParameter("btngrant")!=null)
    {
       ...
       //String s=request.getParameter("id");
       out.println(s);
       String qry="update PERMISSION_TABLE_HOD_JOINEDFACULTY set APPROVE=1 where EMAIL_ID='"+s+"' ";
       int x=stat.executeUpdate(qry);
