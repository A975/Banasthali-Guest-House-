            ...
            //out.println("hi3");
                   ...
                   // out.println("hey email selected");
                    ...
                    while(r.next())
                    {
                        ...
                        //out.println(ph);
                        int i=0;
                        String qI="insert into PERMISSION_TABLE_HOD_EXTERNALSTUDENT values('"+r.getString(1)+"','"+r.getString(5)+"','"+r.getString(7)+"','"+r.getString(8)+"','"+r.getString(9)+"','"+r.getString(10)+"',"+i+")";
