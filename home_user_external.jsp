...
<html>
    ...
    <header>
       ...
       %>
                ...
                <%
        String s="select * from EXTERNALSTUDENT where GEMAIL='"+n+"' ";
...
<li><button class="dropbtn" style="font-size: 15px; padding-right:30px; width:200px;"> HI <%=rs.getString(5)%> </button></li>
    ...
    <%}
       ...
       {}%>    
                ...
                <li> <button class="dropbtn" onclick="window.location.href ='search_room_user_html_external.html';">Search</button></li>
