...
<script>
    ...
    return true;
        ...
        <h3> Your purpose of visit?</h3>
        
        <textarea name="txtpurposeofvisit" placeholder="purpose of visit"size="40" required></textarea>
        

        <h3>Date of Allotment</h3>
        
         <input type="text" placeholder="Date"  name="dquarter" value="" size="30" id="datepicker" required=""/>
        
       <h3>Enter department to visit</h3>
        
          <input type="text" name="dept" placeholder="department to visit" value="" size="30" required=""/>
   ...
   try
   {
       ...
       if(request.getParameter("btninsert")!=null)
       {
          ...
          //out.println("Hi1");
           ...
           String JDATEOFALLOTMENT=request.getParameter("dquarter");
           ...
           Class.forName("org.apache.derby.jdbc.ClientDriver");
            ...
            out.println("hi111");
            out.println("hii2");
         /* out.println(GEMAILID);
            out.println(PASSWORD);
            out.println(CONFIRMP);
            out.println(NICKNAME);
            out.println(GNAME);
            out.println(GENDER);
            
            out.println(ADDRESS);
                    //out.println(RELATIONWITHSTUDENT);
                    out.println(PURPOSEOFVISIT);
                    //out.println(STUDENTID);
                    out.println(GDEPARTTOVISIT);
                    out.println(JDATEOFALLOTMENT);*/
                    
          int x=stat.executeUpdate("insert into JOINED_FACULTY values('"+GEMAILID+"','"+PASSWORD+"','"+CONFIRMP+"','"+NICKNAME+"','"+GNAME+"','"+GENDER+"','"+ADDRESS+"','"+PURPOSEOFVISIT+"','"+GDEPARTTOVISIT+"','"+JDATEOFALLOTMENT+"')");        
          out.println("hii4");
           if(x>0){%>
               <a href="home_user_joined.jsp?id=<%=GEMAILID%>" class="notification">
