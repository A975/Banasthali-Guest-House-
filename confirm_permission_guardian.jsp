...
<%
        ...
        if(request.getParameter("btnnotgrant")!=null)
    {
       ...
       //String s=request.getParameter("id");
       out.println(s);
       String qry="delete from PERMISSION_TABLE_WARDEN_GUARDIAN  where GEMAILID='"+s+"' ";
...
out.println(result);}
    ...
    if(request.getParameter("btngrant")!=null)
    {
       ...
       //String s=request.getParameter("id");
       out.println(s);
       String qry="update PERMISSION_TABLE_WARDEN_GUARDIAN set APPROVE=1 where GEMAILID='"+s+"' ";
       int x=stat.executeUpdate(qry);
