...
<script>
    ...
    return true;
        ...
        <input type="radio" name="g" />Other
         ...
         <h3>Relation with student</h3>
        
         <input type="text" placeholder="Relation with student" name="txtrelationwithstudent" value="" size="30" required=""/>
        ...
        <input type="text" name="txtstudentid" placeholder="College ID of the Student" vaue="" size="30" required>
        
        
        
        <h3>Hostel of Student</h3>
            <input type="text" name="txtstudenthostel" placeholder="Hostel of the student" vaue="" size="30">
...
<%
   try
   {
       ...
       if(request.getParameter("btninsert")!=null)
       {
          ...
          int x=stat.executeUpdate("insert into GUARDIAN values('"+GEMAILID+"','"+PASSWORD+"','"+CONFIRMP+"','"+NICKNAME+"','"+GNAME+"','"+GENDER+"','"+ADDRESS+"','"+RELATIONWITHSTUDENT+"','"+PURPOSEOFVISIT+"','"+STUDENTID+"','"+STUDENTHOSTEL+"')");          
          out.println("hii4");
           if(x>0)
               %>
