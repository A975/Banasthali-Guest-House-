...
<html>
    ...
    <header>
       ...
       %>
                ...
                <%
        String s="select * from GUEST_FACULTY where GEMAILID='"+n+"' ";
...
<li><button class="dropbtn" style="font-size: 15px; padding-right:30px; width:200px;"> HI <%=rs.getString(5)%> </button></li>
    ...
    <%}
       ...
       {}%>    
                ...
                <li> <button class="dropbtn" onclick="window.location.href ='home_try1.html';">Home</button></li>
                
                
                <li> <button class="dropbtn" onclick="window.location.href ='search_room_user_html_guest.html';">Search</button></li>
  ...
  <div class="column">
    ...
    <div class="master">
       ...
       <!-- <select name="login">
           ...
           <option><a href="seach_room1.html">Admin</a></option>
        <option><a href="search_room1.html">User</a></option>
        <option><a href="#">HOD</a></option>
        <option><a href="home.html">Warden</a></option>
        </select>
