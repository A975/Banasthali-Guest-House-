...
<%@page import="java.sql.*"%>
<%@page contentType="text/html"import="java.net.*;" pageEncoding="UTF-8"%>
        ...
        <form name="l" method="post">
            <table>
                <% 
                    ...
                    out.println(s);
                %>
                <tr><td>Are you sure you want to grant permission for stay to <%=request.getParameter("id")%></td></tr>
...
<%
        ...
        if(request.getParameter("btnnotgrant")!=null)
    {
       ...
       //String s=request.getParameter("id");
       out.println(s);
       String qry="delete from PERMISSION_TABLE_HOD_GUESTFACULTY  where GEMAILID='"+s+"' ";
...
out.println(result);}
    ...
    if(request.getParameter("btngrant")!=null)
    {
       ...
       //String s=request.getParameter("id");
       out.println(s);
       String qry="update PERMISSION_TABLE_HOD_GUESTFACULTY set APPROVE=1 where GEMAILID='"+s+"' ";
       int x=stat.executeUpdate(qry);
