...
<html>
    ...
    <header>
       ...
       %>
                ...
                <%
        String s="select * from JOINED_FACULTY where GEMAILID='"+n+"' ";
...
<li><button class="dropbtn" style="font-size: 15px; padding-right:30px; width:200px;"> HI <%=rs.getString(5)%> </button></li>
    ...
    <%}
       ...
       {}%>    
                ...
                <li> <button class="dropbtn" onclick="window.location.href ='search_room_user_html_joined.html';">Search</button></li>
