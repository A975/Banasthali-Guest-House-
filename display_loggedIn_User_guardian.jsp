    ...
    try
    {
        ...
        if(user.equals("Guardian"))
        {
            ...
            //out.println("hi3");
                    ...
                    String qryP="select * from GUARDIAN where GEMAIL='"+email+"'";
                   // out.println("hey email selected");
                    ...
                    while(r.next())
                    {
                        ...
                        //out.println(ph);
                        int i=0;
                        String qI="insert into PERMISSION_TABLE_WARDEN_GUARDIAN values('"+r.getString(1)+"','"+r.getString(5)+"','"+r.getString(8)+"','"+r.getString(9)+"','"+r.getString(10)+"','"+r.getString(11)+"',"+i+")";
